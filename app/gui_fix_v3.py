...
class InterfazNotas:
    ...
    def setup_nota_tab(self, parent, tipo_nota):
        ...
        fecha_var = tk.StringVar(value=datetime.datetime.now().strftime('%Y-%m-%d'))
    ...
    def setup_consultas_tab(self):
        ...
        self.fecha_desde_var = tk.StringVar(value=datetime.datetime.now().strftime('%Y-%m-%d'))
        ...
        self.fecha_hasta_var = tk.StringVar(value=datetime.datetime.now().strftime('%Y-%m-%d'))
    ...
    def generar_nota(self, tipo_nota):
        ...
        try:
            # Importar datetime localmente como respaldo
