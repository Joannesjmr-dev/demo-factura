...
class InterfazNotas:
    ...
    def setup_nota_tab(self, parent, tipo_nota):
        ...
        # Importar datetime localmente para evitar conflictos
        import datetime as dt
        fecha_var = tk.StringVar(value=dt.datetime.now().strftime('%Y-%m-%d'))
    ...
    def setup_consultas_tab(self):
        ...
        # Importar datetime localmente para evitar conflictos
        import datetime as dt
        self.fecha_desde_var = tk.StringVar(value=dt.datetime.now().strftime('%Y-%m-%d'))
        ...
        self.fecha_hasta_var = tk.StringVar(value=dt.datetime.now().strftime('%Y-%m-%d'))
